...
The authenticated routes Inicio, Explorar, Comunidad, Mapa, Mensajes, EstadÃ­sticas, Perfil and Centro de ayuda SHALL preserve the accepted prototype shell, composition, interaction placement and region-local feedback while their data sources are reconnected.
