...
| -------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| Inicio y libros            | Catálogo público, libros propios, detalle, edición, búsqueda e intereses; búsqueda autenticada de personas desde Publicaciones | Validar el recorrido completo en navegador con datos creados durante la sesión y revisar privacidad/seguimiento de personas |
...
| Mapa                       | Rincones, publicaciones y actividad con radio y ubicación contextual; centro de dispositivo o zona privada de perfil | Comprobar permiso concedido, rechazado y ausente, zona de perfil, radio ilimitado, ausencia de distancia inventada y coherencia mapa/listado |
